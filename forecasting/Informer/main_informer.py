import torch
import numpy as np
from forecasting.Informer.exp.exp_informer import ExpInformer
...
def main_informer(args):
    data_parser = {
        ...
        'aus': {'data': 'aus_electrical_demand_points.parquet', 'T': 'y', 'M': [1, 1, 1], 'S': [1, 1, 1], 'MS': [1, 1, 1]},
    ...
    for ii in range(args.itr):
        for eb in args.EB:
            ...
            setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_eb{}_train_raw{}_{}_{}'.format(args.model_id,
                                                                                                                    ...
                                                                                                                    args.train_raw,
                                                                                                                    args.des, ii)
            setting += '_retrain' if args.retrain == 1 else ''
            if eb == 0.0:
